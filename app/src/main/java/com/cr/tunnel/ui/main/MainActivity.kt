...
import com.cr.tunnel.ui.AboutActivity
...
import com.cr.tunnel.ui.server.ProfileEditorResult
import com.cr.tunnel.ui.server.ServerCustomConfigActivity
import com.cr.tunnel.ui.server.ServerGroupActivity
import com.cr.tunnel.ui.server.ServerHttpActivity
import com.cr.tunnel.ui.server.ServerHysteria2Activity
import com.cr.tunnel.ui.server.ServerProxyChainActivity
import com.cr.tunnel.ui.server.ServerShadowsocksActivity
import com.cr.tunnel.ui.server.ServerSocksActivity
import com.cr.tunnel.ui.server.ServerTrojanActivity
import com.cr.tunnel.ui.server.ServerVlessActivity
import com.cr.tunnel.ui.server.ServerVmessActivity
import com.cr.tunnel.ui.server.ServerWireguardActivity
import com.cr.tunnel.ui.settings.SettingsActivity
import com.cr.tunnel.ui.subscription.SubSettingActivity
import com.cr.tunnel.ui.userasset.UserAssetActivity
...
class MainActivity : HelperBaseComponentActivity() {
    ...
    override fun ScreenContent() {
        ...
        LaunchedEffect(Unit) {
            mainViewModel.autoConnectRequest.collectLatest { timestamp ->
                if (timestamp > 0L) {
                    handleFabAction()
                }
            }
